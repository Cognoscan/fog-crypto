...
impl LockLockboxRef {
    ...
    fn new_ref(lockbox_ref: &LockboxRef) -> &Self {
        ...
        unsafe {
            &*(lockbox_ref as *const LockboxRef as *const LockLockboxRef)
        }
    }
...
impl ToOwned for LockLockboxRef {
    ...
    fn to_owned(&self) -> Self::Owned {
        LockLockbox(Lockbox { inner: Vec::from(&self.0.inner) })
    }
}
...
impl IdentityLockboxRef {
    ...
    fn new_ref(lockbox_ref: &LockboxRef) -> &Self {
        ...
        // more justification, as it does the same thing.
        unsafe {
            &*(lockbox_ref as *const LockboxRef as *const IdentityLockboxRef)
        }
    }
...
impl ToOwned for IdentityLockboxRef {
    ...
    #[inline]
    fn to_owned(&self) -> Self::Owned {
        IdentityLockbox(Lockbox { inner: Vec::from(&self.0.inner) })
    }
}
...
impl StreamLockboxRef {
    ...
    fn new_ref(lockbox_ref: &LockboxRef) -> &Self {
        ...
        // more justification, as it does the same thing.
        unsafe {
            &*(lockbox_ref as *const LockboxRef as *const StreamLockboxRef)
        }
    }
...
impl ToOwned for StreamLockboxRef {
    ...
    #[inline]
    fn to_owned(&self) -> Self::Owned {
        StreamLockbox(Lockbox { inner: Vec::from(&self.0.inner) })
    }
}
...
impl DataLockboxRef {
    ...
    fn new_ref(lockbox_ref: &LockboxRef) -> &Self {
        ...
        // more justification, as it does the same thing.
        unsafe {
            &*(lockbox_ref as *const LockboxRef as *const DataLockboxRef)
        }
    }
...
impl ToOwned for DataLockboxRef {
    ...
    #[inline]
    fn to_owned(&self) -> Self::Owned {
        DataLockbox(Lockbox { inner: Vec::from(&self.0.inner) })
    }
}
...
impl LockboxRef {
    ...
    fn new_ref(buf: &[u8]) -> &Self {
        ...
        unsafe {
            &*(buf as *const [u8] as *const LockboxRef)
        }
    }
...
impl ToOwned for LockboxRef {
    ...
    #[inline]
    fn to_owned(&self) -> Self::Owned {
        Lockbox { inner: Vec::from(&self.inner) }
    }
}
